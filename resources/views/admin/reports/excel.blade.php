<table>
    <thead>
        <tr>
            <th style="background-color: #1e3a5f; color: #ffffff; font-weight: bold; font-size: 12px; text-align: center; padding: 8px;" colspan="6">
        ...
        <tr>
            ...
            <th style="background-color: #f1f5f9; font-weight: bold; border: 1px solid #cbd5e1; padding: 6px;">Ref#</th>
            <th style="background-color: #f1f5f9; font-weight: bold; border: 1px solid #cbd5e1; padding: 6px;">Deskripsi</th>
            <th style="background-color: #f1f5f9; font-weight: bold; border: 1px solid #cbd5e1; padding: 6px;">Kategori</th>
    ...
    <tbody>
        @foreach ($transactions as $t)
            <tr>
                ...
                <td style="border: 1px solid #e2e8f0; padding: 5px;">{{ $t->reference_number ?? '-' }}</td>
                <td style="border: 1px solid #e2e8f0; padding: 5px;">{{ $t->description ?? '-' }}</td>
                <td style="border: 1px solid #e2e8f0; padding: 5px;">{{ $t->category->name }}</td>
    ...
    <tfoot>
        <tr>
            <td colspan="5" style="border: 1px solid #cbd5e1; padding: 6px; font-weight: bold; text-align: right; background-color: #f8fafc;">Total Pemasukan</td>
        ...
        <tr>
            <td colspan="5" style="border: 1px solid #cbd5e1; padding: 6px; font-weight: bold; text-align: right; background-color: #f8fafc;">Total Pengeluaran</td>
        ...
        <tr>
            <td colspan="5" style="border: 1px solid #cbd5e1; padding: 6px; font-weight: bold; text-align: right; background-color: #f1f5f9;">Net Cash Flow</td>
