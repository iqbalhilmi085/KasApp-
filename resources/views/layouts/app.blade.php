            ...
            <nav class="flex-1 overflow-y-auto px-3 py-5 sidebar-scroll space-y-0.5">
                @php
                    $menuItems = [
                        ...
                        ['route' => 'categories.index', 'label' => 'Kategori', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" d="M9.568 3H5.25A2.25 2.25 0 0 0 3 5.25v4.318c0 .597.237 1.17.659 1.591l9.581 9.581c.699.699 1.78.872 2.607.33a18.095 18.095 0 0 0 5.223-5.223c.542-.827.369-1.908-.33-2.607L11.16 3.66A2.25 2.25 0 0 0 9.568 3Z" /><path stroke-linecap="round" stroke-linejoin="round" d="M6 6h.008v.008H6V6Z" />'],
                        ...
                        ['route' => 'activity-log.index', 'label' => 'Log Aktivitas', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />'],
        ...
        <div class="flex-1 flex flex-col min-w-0">
            ...
            <header class="bg-white border-b border-gray-200 px-4 lg:px-6 h-16 flex items-center shrink-0">
                <div class="flex items-center justify-between w-full">
                    ...
                    <div class="flex items-center gap-3">
                        {{-- Live balance --}}
                        <div class="hidden sm:flex items-center gap-2 px-3 py-1.5 bg-emerald-50 border border-emerald-200 rounded-lg">
                            ...
                            <span class="text-sm font-semibold text-emerald-700 tabular-nums" id="header-balance">
                                Rp {{ number_format(\App\Models\CashBalance::getCurrentBalance(), 0, ',', '.') }}
                            </span>
                        </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (balanceEl) {
                setInterval(function() {
                    fetch('{{ route("dashboard.balance") }}')
                        .then(function(r) { return r.json(); })
                        .then(function(d) {
                            if (balanceEl) balanceEl.textContent = d.formatted;
                        })
                        .catch(function() {});
                }, 30000);
            }
