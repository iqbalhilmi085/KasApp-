        ...
        <x-card>
            <form method="GET" class="flex flex-wrap items-end gap-3">
                ...
                <div class="flex gap-2">
                    ...
                    <a href="{{ route('reports.public.export-pdf', ['bulan' => $month, 'tahun' => $year]) }}?{{ http_build_query(request()->except(['month', 'year'])) }}" class="px-5 py-2 text-sm font-semibold text-white bg-red-600 rounded-lg hover:bg-red-700 transition-colors">
                        Export PDF
                    </a>
                </div>
            </form>
                    ...
                    <table class="w-full text-sm">
                        ...
                        <tfoot>
                            <tr class="bg-gray-50 font-semibold border-t-2 border-gray-200">
                                <td colspan="2" class="px-4 py-3 text-xs text-gray-600 uppercase tracking-wider">Total</td>
